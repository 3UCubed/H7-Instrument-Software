...
uint8_t voltage_monitor_init() {
	...
	rail_monitor[RAIL_vrefint].max_voltage = 4095;
	rail_monitor[RAIL_vrefint].min_voltage = 3350;
	...
	rail_monitor[RAIL_TEMP1].max_voltage = 800;
	rail_monitor[RAIL_TEMP1].min_voltage = 7872;
	...
	rail_monitor[RAIL_TEMP2].max_voltage = 800;
	rail_monitor[RAIL_TEMP2].min_voltage = 7872;
	...
	rail_monitor[RAIL_TEMP3].max_voltage = 800;
	rail_monitor[RAIL_TEMP3].min_voltage = 7872;
	...
	rail_monitor[RAIL_TEMP4].max_voltage = 800;
	rail_monitor[RAIL_TEMP4].min_voltage = 7872;
	...
	rail_monitor[RAIL_2v5].max_voltage = 3414;
	rail_monitor[RAIL_2v5].min_voltage = 2792;
	...
	rail_monitor[RAIL_3v3].max_voltage = 4095;
	rail_monitor[RAIL_3v3].min_voltage = 3350;
	...
	rail_monitor[RAIL_5v].max_voltage = 4095;
	rail_monitor[RAIL_5v].min_voltage = 3350;
	...
	rail_monitor[RAIL_n3v3].max_voltage = 4286;
	rail_monitor[RAIL_n3v3].min_voltage = 3507;
	...
	rail_monitor[RAIL_n5v].max_voltage = 4150;
	rail_monitor[RAIL_n5v].min_voltage = 3395;
	...
	rail_monitor[RAIL_15v].max_voltage = 4095;
	rail_monitor[RAIL_15v].min_voltage = 3350;
	...
	rail_monitor[RAIL_5vref].max_voltage = 4095;
	rail_monitor[RAIL_5vref].min_voltage = 3350;
	...
	rail_monitor[RAIL_n200v].max_voltage = 3686;
	rail_monitor[RAIL_n200v].min_voltage = 3015;
	...
	rail_monitor[RAIL_n800v].max_voltage = 3494;
	rail_monitor[RAIL_n800v].min_voltage = 2859;
