...
#define LL_DMAMUX_ReadReg(__INSTANCE__, __REG__) READ_REG(__INSTANCE__->__REG__)
	...
	__STATIC_INLINE void LL_DMAMUX_SetRequestID(DMAMUX_Channel_TypeDef *DMAMUXx,
		...
		MODIFY_REG(
				((DMAMUX_Channel_TypeDef *)(dmamux_base_addr + (DMAMUX_CCR_SIZE * (Channel))))->CCR,
	...
	__STATIC_INLINE void LL_DMAMUX_SetSyncRequestNb(
		...
		MODIFY_REG(
				((DMAMUX_Channel_TypeDef *)(dmamux_base_addr + (DMAMUX_CCR_SIZE * (Channel))))->CCR,
				DMAMUX_CxCR_NBREQ, (RequestNb - 1U) << DMAMUX_CxCR_NBREQ_Pos);
	}
	...
	__STATIC_INLINE void LL_DMAMUX_EnableRequestGen(
		...
		SET_BIT(
				((DMAMUX_RequestGen_TypeDef *)(dmamux_base_addr + DMAMUX_REQ_GEN_OFFSET + (DMAMUX_RGCR_SIZE * (RequestGenChannel))))->RGCR,
				DMAMUX_RGxCR_GE);
	}
	...
	__STATIC_INLINE uint32_t LL_DMAMUX_IsActiveFlag_SO0(
		...
		return ((READ_BIT(
				((DMAMUX_ChannelStatus_TypeDef *)(dmamux_base_addr + DMAMUX_CH_STATUS_OFFSET))->CSR,
				DMAMUX_CSR_SOF0)
	 ...
	 * @retval State of bit (1 or 0).
	 */
	__STATIC_INLINE uint32_t LL_DMAMUX_IsActiveFlag_SO12(
			DMAMUX_Channel_TypeDef *DMAMUXx) {
		uint32_t dmamux_base_addr = (uint32_t) DMAMUXx;
	 ...
	 * @retval State of bit (1 or 0).
	 */
	__STATIC_INLINE uint32_t LL_DMAMUX_IsActiveFlag_SO13(
			DMAMUX_Channel_TypeDef *DMAMUXx) {
		uint32_t dmamux_base_addr = (uint32_t) DMAMUXx;
	 ...
	 * @retval State of bit (1 or 0).
	 */
	__STATIC_INLINE uint32_t LL_DMAMUX_IsActiveFlag_SO14(
			DMAMUX_Channel_TypeDef *DMAMUXx) {
		uint32_t dmamux_base_addr = (uint32_t) DMAMUXx;
	 ...
	 * @retval State of bit (1 or 0).
	 */
	__STATIC_INLINE uint32_t LL_DMAMUX_IsActiveFlag_SO15(
			DMAMUX_Channel_TypeDef *DMAMUXx) {
		uint32_t dmamux_base_addr = (uint32_t) DMAMUXx;
	...
	__STATIC_INLINE uint32_t LL_DMAMUX_IsActiveFlag_RGO0(
		...
		return ((READ_BIT(
				((DMAMUX_RequestGenStatus_TypeDef *)(dmamux_base_addr + DMAMUX_REQ_GEN_STATUS_OFFSET))->RGSR,
				DMAMUX_RGSR_OF0)
	 ...
	 * @retval State of bit (1 or 0).
	 */
	__STATIC_INLINE uint32_t LL_DMAMUX_IsActiveFlag_RGO4(
			DMAMUX_Channel_TypeDef *DMAMUXx) {
		uint32_t dmamux_base_addr = (uint32_t) DMAMUXx;
	 ...
	 * @retval State of bit (1 or 0).
	 */
	__STATIC_INLINE uint32_t LL_DMAMUX_IsActiveFlag_RGO5(
			DMAMUX_Channel_TypeDef *DMAMUXx) {
		uint32_t dmamux_base_addr = (uint32_t) DMAMUXx;
	 ...
	 * @retval State of bit (1 or 0).
	 */
	__STATIC_INLINE uint32_t LL_DMAMUX_IsActiveFlag_RGO6(
			DMAMUX_Channel_TypeDef *DMAMUXx) {
		uint32_t dmamux_base_addr = (uint32_t) DMAMUXx;
	 ...
	 * @retval State of bit (1 or 0).
	 */
	__STATIC_INLINE uint32_t LL_DMAMUX_IsActiveFlag_RGO7(
			DMAMUX_Channel_TypeDef *DMAMUXx) {
		uint32_t dmamux_base_addr = (uint32_t) DMAMUXx;
	...
	__STATIC_INLINE void LL_DMAMUX_ClearFlag_SO0(
		...
		SET_BIT(
				((DMAMUX_ChannelStatus_TypeDef *)(dmamux_base_addr + DMAMUX_CH_STATUS_OFFSET))->CFR,
				DMAMUX_CFR_CSOF0);
	}
	 ...
	 * @retval None
	 */
	__STATIC_INLINE void LL_DMAMUX_ClearFlag_SO12(
			DMAMUX_Channel_TypeDef *DMAMUXx) {
		uint32_t dmamux_base_addr = (uint32_t) DMAMUXx;
	 ...
	 * @retval None
	 */
	__STATIC_INLINE void LL_DMAMUX_ClearFlag_SO13(
			DMAMUX_Channel_TypeDef *DMAMUXx) {
		uint32_t dmamux_base_addr = (uint32_t) DMAMUXx;
	 ...
	 * @retval None
	 */
	__STATIC_INLINE void LL_DMAMUX_ClearFlag_SO14(
			DMAMUX_Channel_TypeDef *DMAMUXx) {
		uint32_t dmamux_base_addr = (uint32_t) DMAMUXx;
	 ...
	 * @retval None
	 */
	__STATIC_INLINE void LL_DMAMUX_ClearFlag_SO15(
			DMAMUX_Channel_TypeDef *DMAMUXx) {
		uint32_t dmamux_base_addr = (uint32_t) DMAMUXx;
	...
	__STATIC_INLINE void LL_DMAMUX_ClearFlag_RGO0(
		...
		SET_BIT(
				((DMAMUX_RequestGenStatus_TypeDef *)(dmamux_base_addr + DMAMUX_REQ_GEN_STATUS_OFFSET))->RGCFR,
				DMAMUX_RGCFR_COF0);
	}
	 ...
	 * @retval None
	 */
	__STATIC_INLINE void LL_DMAMUX_ClearFlag_RGO4(
			DMAMUX_Channel_TypeDef *DMAMUXx) {
		uint32_t dmamux_base_addr = (uint32_t) DMAMUXx;
	 ...
	 * @retval None
	 */
	__STATIC_INLINE void LL_DMAMUX_ClearFlag_RGO5(
			DMAMUX_Channel_TypeDef *DMAMUXx) {
		uint32_t dmamux_base_addr = (uint32_t) DMAMUXx;
	 ...
	 * @retval None
	 */
	__STATIC_INLINE void LL_DMAMUX_ClearFlag_RGO6(
			DMAMUX_Channel_TypeDef *DMAMUXx) {
		uint32_t dmamux_base_addr = (uint32_t) DMAMUXx;
	 ...
	 * @retval None
	 */
	__STATIC_INLINE void LL_DMAMUX_ClearFlag_RGO7(
			DMAMUX_Channel_TypeDef *DMAMUXx) {
		uint32_t dmamux_base_addr = (uint32_t) DMAMUXx;
	...
	__STATIC_INLINE void LL_DMAMUX_EnableIT_SO(DMAMUX_Channel_TypeDef *DMAMUXx,
		...
		SET_BIT(
				((DMAMUX_Channel_TypeDef *)((uint32_t)(dmamux_base_addr + (DMAMUX_CCR_SIZE * (Channel)))))->CCR,
				DMAMUX_CxCR_SOIE);
	}
