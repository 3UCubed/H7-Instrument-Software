...
#define __LL_ADC_CALC_TEMPERATURE_TYP_PARAMS(__TEMPSENSOR_TYP_AVGSLOPE__,\
  ...
  MODIFY_REG(ADCx->CALFACT_RES13,
	 ...
	 */
	__STATIC_INLINE uint32_t LL_ADC_GetCalibrationOffsetFactor(
  ...
  if (ADCx != ADC3)
  {
    ...
    while ((READ_BIT(ADCx->CR, LinearityWord) == 0UL) && (timeout_cpu_cycles > 0UL))
    {
      timeout_cpu_cycles--;
		...
		MODIFY_REG(ADCx->CR, ADC_CR_ADCALLIN, LinearityWord);
		while ((READ_BIT(ADCx->CR, LinearityWord) == 0UL)
				&& (timeout_cpu_cycles > 0UL)) {
			timeout_cpu_cycles--;
		}
#endif /* ADC_VER_V5_V90 */
	}
	 ...
	 */
	__STATIC_INLINE uint32_t LL_ADC_GetCalibrationLinearFactor(
  ...
  else
  {
    ...
    else
    {
      return (uint32_t)(READ_BIT(ADCx->CFGR, ADC_CFGR_RES));
		...
		{
			if ((uint32_t) (READ_BIT(ADCx->CFGR, ADC_CFGR_RES))
					== 0x0000001CUL) {
				return (LL_ADC_RESOLUTION_8B);
			} else {
				return (uint32_t) (READ_BIT(ADCx->CFGR, ADC_CFGR_RES));
    ...
    if (ADCx != ADC3)
    {
      ...
      ADCx->PCSEL_RES0 |= (1UL << (__LL_ADC_CHANNEL_TO_DECIMAL_NB(Channel) & 0x1FUL));
		...
		/* ADC channels preselection */
		ADCx->PCSEL |= (1UL
				<< (__LL_ADC_CHANNEL_TO_DECIMAL_NB(Channel) & 0x1FUL));
#endif /* ADC_VER_V5_V90 */
	}
...
#else
		/* Gets preselected ADC channel */
		return (uint32_t) (READ_BIT(ADCx->PCSEL,
				1UL << (__LL_ADC_CHANNEL_TO_DECIMAL_NB(Channel) & 0x1FUL)));
#endif /* ADC_VER_V5_V90 */
	}
  ...
  if (ADCx == ADC3)
  {
	...
	__STATIC_INLINE uint32_t LL_ADC_GetDataRightShift(ADC_TypeDef *ADCx,
			uint32_t Offsety) {
		return (uint32_t) ((READ_BIT(ADCx->CFGR2,
				(ADC_CFGR2_RSHIFT1 << (Offsety & 0x1FUL))))
				>> (Offsety & 0x1FUL));
	}
  ...
  if (ADCx == ADC3)
  {
...
#endif  /* ADC_VER_V5_V90 */
		{
			const __IO uint32_t *preg = __ADC_PTR_REG_OFFSET(ADCx->OFR1,
					Offsety);
	...
	__STATIC_INLINE uint32_t LL_ADC_REG_GetTriggerSource(ADC_TypeDef *ADCx) {
		__IO uint32_t TriggerSource = READ_BIT(ADCx->CFGR,
	...
	__STATIC_INLINE void LL_ADC_INJ_SetTriggerSource(ADC_TypeDef *ADCx,
			uint32_t TriggerSource) {
		MODIFY_REG(ADCx->JSQR, ADC_JSQR_JEXTSEL | ADC_JSQR_JEXTEN,
				TriggerSource);
	}
	...
	__STATIC_INLINE uint32_t LL_ADC_INJ_GetTriggerSource(ADC_TypeDef *ADCx) {
		__IO uint32_t TriggerSource = READ_BIT(ADCx->JSQR,
	 ...
	 *         Value "1" if trigger source SW start.
	 */
	__STATIC_INLINE uint32_t LL_ADC_INJ_IsTriggerSourceSWStart(
			ADC_TypeDef *ADCx) {
		return ((READ_BIT(ADCx->JSQR, ADC_JSQR_JEXTEN)
				== (LL_ADC_INJ_TRIG_SOFTWARE & ADC_JSQR_JEXTEN)) ? 1UL : 0UL);
	}
	...
	__STATIC_INLINE void LL_ADC_INJ_ConfigQueueContext(ADC_TypeDef *ADCx,
			uint32_t TriggerSource, uint32_t ExternalTriggerEdge,
			uint32_t SequencerNbRanks, uint32_t Rank1_Channel,
			uint32_t Rank2_Channel, uint32_t Rank3_Channel,
  ...
  return (uint32_t)(READ_BIT(ADCx->DIFSEL_RES12, (Channel & ADC_SINGLEDIFF_CHANNEL_MASK)));
	...
	__STATIC_INLINE uint32_t LL_ADC_GetAnalogWDMonitChannels(ADC_TypeDef *ADCx,
		...
		uint32_t AnalogWDMonitChannels = (READ_BIT(*preg, AWDy) & AWDy
  ...
  else
  {
    ...
    MODIFY_REG(*preg, ADC_LTR_LT, AWDThresholdValue);
		...
		/* containing other bits reserved for other purpose.                        */
		__IO uint32_t *preg =
				__ADC_PTR_REG_OFFSET(ADCx->LTR1,
						(((AWDy & ADC_AWD_TRX_REGOFFSET_MASK) >> ADC_AWD_TRX_REGOFFSET_POS) * 2UL) + ((AWDy & ADC_AWD_TR12_REGOFFSETGAP_MASK) * ADC_AWD_TR12_REGOFFSETGAP_VAL) + (AWDThresholdsHighLow));
  ...
  else
  {
	...
	__STATIC_INLINE void LL_ADC_SetOverSamplingScope(ADC_TypeDef *ADCx,
			uint32_t OvsScope) {
		MODIFY_REG(ADCx->CFGR2,
				ADC_CFGR2_ROVSE | ADC_CFGR2_JOVSE | ADC_CFGR2_ROVSM, OvsScope);
	}
	...
	__STATIC_INLINE uint32_t LL_ADC_GetOverSamplingScope(ADC_TypeDef *ADCx) {
		return (uint32_t) (READ_BIT(ADCx->CFGR2,
				ADC_CFGR2_ROVSE | ADC_CFGR2_JOVSE | ADC_CFGR2_ROVSM));
	}
  ...
  if (ADCx != ADC3)
  {
	...
	__STATIC_INLINE uint32_t LL_ADC_GetBoostMode(ADC_TypeDef *ADCx) {
		...
		{
			return ((READ_BIT(ADCx->CR, ADC_CR_BOOST) == (ADC_CR_BOOST)) ?
					1UL : 0UL);
		}
	}
	...
	__STATIC_INLINE uint32_t LL_ADC_REG_ReadMultiConversionData32(
		...
		return (uint32_t) (READ_BIT(ADCxy_COMMON->CDR,
				ConversionData) >> (POSITION_VAL(ConversionData) & 0x1FUL));
	}
	 ...
	 */
	__STATIC_INLINE uint32_t LL_ADC_INJ_IsStopConversionOngoing(
			ADC_TypeDef *ADCx) {
	...
	__STATIC_INLINE uint32_t LL_ADC_INJ_ReadConversionData32(ADC_TypeDef *ADCx,
			uint32_t Rank) {
		const __IO uint32_t *preg =
				__ADC_PTR_REG_OFFSET(ADCx->JDR1,
	...
	__STATIC_INLINE uint32_t LL_ADC_IsActiveFlag_LDORDY(ADC_TypeDef *ADCx) {
		return ((READ_BIT(ADCx->ISR, LL_ADC_FLAG_LDORDY) == (LL_ADC_FLAG_LDORDY)) ?
				1UL : 0UL);
	}
	 ...
	 * @retval State of bit (1 or 0).
	 */
	__STATIC_INLINE uint32_t LL_ADC_IsActiveFlag_MST_ADRDY(
			ADC_Common_TypeDef *ADCxy_COMMON) {
	 ...
	 * @retval State of bit (1 or 0).
	 */
	__STATIC_INLINE uint32_t LL_ADC_IsActiveFlag_SLV_ADRDY(
			ADC_Common_TypeDef *ADCxy_COMMON) {
	 ...
	 * @retval State of bit (1 or 0).
	 */
	__STATIC_INLINE uint32_t LL_ADC_IsActiveFlag_MST_EOC(
			ADC_Common_TypeDef *ADCxy_COMMON) {
	 ...
	 * @retval State of bit (1 or 0).
	 */
	__STATIC_INLINE uint32_t LL_ADC_IsActiveFlag_SLV_EOC(
			ADC_Common_TypeDef *ADCxy_COMMON) {
		return ((READ_BIT(ADCxy_COMMON->CSR, LL_ADC_FLAG_EOC_SLV)
				== (LL_ADC_FLAG_EOC_SLV)) ? 1UL : 0UL);
	}
	 ...
	 * @retval State of bit (1 or 0).
	 */
	__STATIC_INLINE uint32_t LL_ADC_IsActiveFlag_MST_EOS(
			ADC_Common_TypeDef *ADCxy_COMMON) {
	 ...
	 * @retval State of bit (1 or 0).
	 */
	__STATIC_INLINE uint32_t LL_ADC_IsActiveFlag_SLV_EOS(
			ADC_Common_TypeDef *ADCxy_COMMON) {
	 ...
	 * @retval State of bit (1 or 0).
	 */
	__STATIC_INLINE uint32_t LL_ADC_IsActiveFlag_SLV_OVR(
			ADC_Common_TypeDef *ADCxy_COMMON) {
	 ...
	 * @retval State of bit (1 or 0).
	 */
	__STATIC_INLINE uint32_t LL_ADC_IsActiveFlag_MST_EOSMP(
			ADC_Common_TypeDef *ADCxy_COMMON) {
	 ...
	 * @retval State of bit (1 or 0).
	 */
	__STATIC_INLINE uint32_t LL_ADC_IsActiveFlag_SLV_EOSMP(
			ADC_Common_TypeDef *ADCxy_COMMON) {
	 ...
	 * @retval State of bit (1 or 0).
	 */
	__STATIC_INLINE uint32_t LL_ADC_IsActiveFlag_MST_JEOC(
			ADC_Common_TypeDef *ADCxy_COMMON) {
	 ...
	 * @retval State of bit (1 or 0).
	 */
	__STATIC_INLINE uint32_t LL_ADC_IsActiveFlag_SLV_JEOC(
			ADC_Common_TypeDef *ADCxy_COMMON) {
	 ...
	 * @retval State of bit (1 or 0).
	 */
	__STATIC_INLINE uint32_t LL_ADC_IsActiveFlag_MST_JEOS(
			ADC_Common_TypeDef *ADCxy_COMMON) {
	 ...
	 * @retval State of bit (1 or 0).
	 */
	__STATIC_INLINE uint32_t LL_ADC_IsActiveFlag_SLV_JEOS(
			ADC_Common_TypeDef *ADCxy_COMMON) {
	 ...
	 * @retval State of bit (1 or 0).
	 */
	__STATIC_INLINE uint32_t LL_ADC_IsActiveFlag_MST_JQOVF(
			ADC_Common_TypeDef *ADCxy_COMMON) {
	 ...
	 * @retval State of bit (1 or 0).
	 */
	__STATIC_INLINE uint32_t LL_ADC_IsActiveFlag_SLV_JQOVF(
			ADC_Common_TypeDef *ADCxy_COMMON) {
	 ...
	 * @retval State of bit (1 or 0).
	 */
	__STATIC_INLINE uint32_t LL_ADC_IsActiveFlag_MST_AWD1(
			ADC_Common_TypeDef *ADCxy_COMMON) {
	 ...
	 * @retval State of bit (1 or 0).
	 */
	__STATIC_INLINE uint32_t LL_ADC_IsActiveFlag_SLV_AWD1(
			ADC_Common_TypeDef *ADCxy_COMMON) {
	 ...
	 * @retval State of bit (1 or 0).
	 */
	__STATIC_INLINE uint32_t LL_ADC_IsActiveFlag_MST_AWD2(
			ADC_Common_TypeDef *ADCxy_COMMON) {
	 ...
	 * @retval State of bit (1 or 0).
	 */
	__STATIC_INLINE uint32_t LL_ADC_IsActiveFlag_SLV_AWD2(
			ADC_Common_TypeDef *ADCxy_COMMON) {
	 ...
	 * @retval State of bit (1 or 0).
	 */
	__STATIC_INLINE uint32_t LL_ADC_IsActiveFlag_MST_AWD3(
			ADC_Common_TypeDef *ADCxy_COMMON) {
	 ...
	 * @retval State of bit (1 or 0).
	 */
	__STATIC_INLINE uint32_t LL_ADC_IsActiveFlag_SLV_AWD3(
			ADC_Common_TypeDef *ADCxy_COMMON) {
