...
#define __LL_I2C_CONVERT_TIMINGS(__PRESCALER__, __SETUP_TIME__, __HOLD_TIME__, __SCLH_PERIOD__, __SCLL_PERIOD__) \
  ((((uint32_t)(__PRESCALER__)    << I2C_TIMINGR_PRESC_Pos)  & I2C_TIMINGR_PRESC)   | \
   ...
   (((uint32_t)(__SCLL_PERIOD__)  << I2C_TIMINGR_SCLL_Pos)   & I2C_TIMINGR_SCLL))
	 ...
	 */
	__STATIC_INLINE uint32_t LL_I2C_DMA_GetRegAddr(const I2C_TypeDef *I2Cx,
			uint32_t Direction) {
	 ...
	 * @retval State of bit (1 or 0).
	 */
	__STATIC_INLINE uint32_t LL_I2C_IsEnabledSlaveByteControl(
			const I2C_TypeDef *I2Cx) {
	 ...
	 * @retval State of bit (1 or 0).
	 */
	__STATIC_INLINE uint32_t LL_I2C_IsEnabledWakeUpFromStop(
			const I2C_TypeDef *I2Cx) {
	 ...
	 *         @arg @ref LL_I2C_ADDRESSING_MODE_10BIT
	 */
	__STATIC_INLINE uint32_t LL_I2C_GetMasterAddressingMode(
			const I2C_TypeDef *I2Cx) {
	...
	__STATIC_INLINE void LL_I2C_SetOwnAddress2(I2C_TypeDef *I2Cx,
			uint32_t OwnAddress2, uint32_t OwnAddrMask) {
	...
	__STATIC_INLINE void LL_I2C_ConfigSMBusTimeout(I2C_TypeDef *I2Cx,
			uint32_t TimeoutA, uint32_t TimeoutAMode, uint32_t TimeoutB) {
	 ...
	 * @retval State of bit (1 or 0).
	 */
	__STATIC_INLINE uint32_t LL_I2C_IsActiveSMBusFlag_PECERR(
			const I2C_TypeDef *I2Cx) {
	 ...
	 * @retval State of bit (1 or 0).
	 */
	__STATIC_INLINE uint32_t LL_I2C_IsActiveSMBusFlag_TIMEOUT(
			const I2C_TypeDef *I2Cx) {
	 ...
	 * @retval State of bit (1 or 0).
	 */
	__STATIC_INLINE uint32_t LL_I2C_IsActiveSMBusFlag_ALERT(
			const I2C_TypeDef *I2Cx) {
	...
	__STATIC_INLINE void LL_I2C_SetTransferSize(I2C_TypeDef *I2Cx,
		...
		MODIFY_REG(I2Cx->CR2, I2C_CR2_NBYTES,
	...
	__STATIC_INLINE void LL_I2C_HandleTransfer(I2C_TypeDef *I2Cx,
			uint32_t SlaveAddr, uint32_t SlaveAddrSize, uint32_t TransferSize,
			uint32_t EndMode, uint32_t Request) {
		/* Declaration of tmp to prevent undefined behavior of volatile usage */
		uint32_t tmp = ((uint32_t) (((uint32_t) SlaveAddr & I2C_CR2_SADD)
				| ((uint32_t) SlaveAddrSize & I2C_CR2_ADD10)
				| (((uint32_t) TransferSize << I2C_CR2_NBYTES_Pos)
						& I2C_CR2_NBYTES) | (uint32_t) EndMode
				| (uint32_t) Request) & (~0x80000000U));

		/* update CR2 register */
		MODIFY_REG(I2Cx->CR2,
				I2C_CR2_SADD | I2C_CR2_ADD10 | (I2C_CR2_RD_WRN & (uint32_t)(Request >> (31U - I2C_CR2_RD_WRN_Pos))) | I2C_CR2_START | I2C_CR2_STOP | I2C_CR2_RELOAD | I2C_CR2_NBYTES | I2C_CR2_AUTOEND | I2C_CR2_HEAD10R,
				tmp);
	}
	 ...
	 * @retval State of bit (1 or 0).
	 */
	__STATIC_INLINE uint32_t LL_I2C_IsEnabledSMBusPECCompare(
			const I2C_TypeDef *I2Cx) {
