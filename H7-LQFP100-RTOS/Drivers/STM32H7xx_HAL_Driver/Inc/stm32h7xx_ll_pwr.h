...
#define LL_PWR_ReadReg(__REG__) READ_REG(PWR->__REG__)
	...
	__STATIC_INLINE uint32_t LL_PWR_IsEnabledPVD(void) {
		return ((READ_BIT(PWR->CR1, PWR_CR1_PVDEN) == (PWR_CR1_PVDEN)) ?
				1UL : 0UL);
	}
	 ...
	 * @retval None
	 */
	__STATIC_INLINE void LL_PWR_SetStopModeRegulVoltageScaling(
	...
	__STATIC_INLINE uint32_t LL_PWR_IsEnabledAVD(void) {
		return ((READ_BIT(PWR->CR1, PWR_CR1_AVDEN) == (PWR_CR1_AVDEN)) ?
				1UL : 0UL);
	}
	...
	__STATIC_INLINE uint32_t LL_PWR_IsEnabledMonitoring(void) {
		return ((READ_BIT(PWR->CR2, PWR_CR2_MONEN) == (PWR_CR2_MONEN)) ?
				1UL : 0UL);
	}
	...
	__STATIC_INLINE void LL_PWR_ConfigSupply(uint32_t SupplySource) {
		/* Set the power supply configuration */
		MODIFY_REG(PWR->CR3, (PWR_CR3_SCUEN | PWR_CR3_LDOEN | PWR_CR3_BYPASS),
				SupplySource);
	}
#endif /* defined (SMPS) */
	...
	__STATIC_INLINE uint32_t LL_PWR_GetSupply(void) {
		/* Get the power supply configuration */
		return (uint32_t) (READ_BIT(PWR->CR3,
	...
	__STATIC_INLINE uint32_t LL_PWR_IsEnabledUSBReg(void) {
		return ((READ_BIT(PWR->CR3, PWR_CR3_USBREGEN) == (PWR_CR3_USBREGEN)) ?
				1UL : 0UL);
	}
	...
	__STATIC_INLINE uint32_t LL_PWR_IsEnabledUSBVoltageDetector(void) {
		return ((READ_BIT(PWR->CR3, PWR_CR3_USB33DEN) == (PWR_CR3_USB33DEN)) ?
				1UL : 0UL);
	}
	...
	__STATIC_INLINE uint32_t LL_PWR_CPU_IsEnabledD3RunInLowPowerMode(void) {
		return ((READ_BIT(PWR->CPUCR, PWR_CPUCR_RUN_D3) == (PWR_CPUCR_RUN_D3)) ?
				1UL : 0UL);
	}
#else
	/**
  ...
  return (uint32_t)(READ_BIT(PWR->SRDCR, PWR_SRDCR_VOS));
	...
	__STATIC_INLINE uint32_t LL_PWR_IsWakeUpPinPolarityLow(uint32_t WakeUpPin) {
		return ((READ_BIT(PWR->WKUPEPR, (WakeUpPin << PWR_WKUPEPR_WKUPP1_Pos))
				== (WakeUpPin << PWR_WKUPEPR_WKUPP1_Pos)) ? 1UL : 0UL);
	}
	...
	__STATIC_INLINE uint32_t LL_PWR_IsActiveFlag_ACTVOS(void) {
		return ((READ_BIT(PWR->CSR1, PWR_CSR1_ACTVOSRDY) == (PWR_CSR1_ACTVOSRDY)) ?
				1UL : 0UL);
	}
	...
	__STATIC_INLINE uint32_t LL_PWR_IsActiveFlag_AVDO(void) {
		return ((READ_BIT(PWR->CSR1, PWR_CSR1_AVDO) == (PWR_CSR1_AVDO)) ?
				1UL : 0UL);
	}
	...
	__STATIC_INLINE uint32_t LL_PWR_IsActiveFlag_BRR(void) {
		return ((READ_BIT(PWR->CR2, PWR_CR2_BRRDY) == (PWR_CR2_BRRDY)) ?
				1UL : 0UL);
	}
	...
	__STATIC_INLINE uint32_t LL_PWR_IsActiveFlag_VBATL(void) {
		return ((READ_BIT(PWR->CR2, PWR_CR2_VBATL) == (PWR_CR2_VBATL)) ?
				1UL : 0UL);
	}
	...
	__STATIC_INLINE uint32_t LL_PWR_IsActiveFlag_VBATH(void) {
		return ((READ_BIT(PWR->CR2, PWR_CR2_VBATH) == (PWR_CR2_VBATH)) ?
				1UL : 0UL);
	}
	...
	__STATIC_INLINE uint32_t LL_PWR_IsActiveFlag_TEMPL(void) {
		return ((READ_BIT(PWR->CR2, PWR_CR2_TEMPL) == (PWR_CR2_TEMPL)) ?
				1UL : 0UL);
	}
	...
	__STATIC_INLINE uint32_t LL_PWR_IsActiveFlag_TEMPH(void) {
		return ((READ_BIT(PWR->CR2, PWR_CR2_TEMPH) == (PWR_CR2_TEMPH)) ?
				1UL : 0UL);
	}
	...
	__STATIC_INLINE uint32_t LL_PWR_IsActiveFlag_USB(void) {
		return ((READ_BIT(PWR->CR3, PWR_CR3_USB33RDY) == (PWR_CR3_USB33RDY)) ?
				1UL : 0UL);
	}
	...
	__STATIC_INLINE uint32_t LL_PWR_CPU_IsActiveFlag_STOP(void) {
		return ((READ_BIT(PWR->CPUCR, PWR_CPUCR_STOPF) == (PWR_CPUCR_STOPF)) ?
				1UL : 0UL);
	}
	...
	__STATIC_INLINE uint32_t LL_PWR_CPU_IsActiveFlag_SB(void) {
		return ((READ_BIT(PWR->CPUCR, PWR_CPUCR_SBF) == (PWR_CPUCR_SBF)) ?
				1UL : 0UL);
	}
	...
	__STATIC_INLINE uint32_t LL_PWR_CPU_IsActiveFlag_SB_D2(void) {
		return ((READ_BIT(PWR->CPUCR, PWR_CPUCR_SBF_D2) == (PWR_CPUCR_SBF_D2)) ?
				1UL : 0UL);
	}
#endif /* PWR_CPUCR_SBF_D2 */
...
#if defined (PWR_CPUCR_PDDS_D2)
		return ((READ_BIT(PWR->D3CR, PWR_D3CR_VOSRDY) == (PWR_D3CR_VOSRDY)) ?
				1UL : 0UL);
#else
  return ((READ_BIT(PWR->SRDCR, PWR_SRDCR_VOSRDY) == (PWR_SRDCR_VOSRDY)) ? 1UL : 0UL);
	...
	__STATIC_INLINE uint32_t LL_PWR_IsActiveFlag_WU6(void) {
		return ((READ_BIT(PWR->WKUPFR, PWR_WKUPFR_WKUPF6) == (PWR_WKUPFR_WKUPF6)) ?
				1UL : 0UL);
	}
	...
	__STATIC_INLINE uint32_t LL_PWR_IsActiveFlag_WU5(void) {
		return ((READ_BIT(PWR->WKUPFR, PWR_WKUPFR_WKUPF5) == (PWR_WKUPFR_WKUPF5)) ?
				1UL : 0UL);
	}
#endif /* defined (PWR_WKUPFR_WKUPF5) */
	...
	__STATIC_INLINE uint32_t LL_PWR_IsActiveFlag_WU4(void) {
		return ((READ_BIT(PWR->WKUPFR, PWR_WKUPFR_WKUPF4) == (PWR_WKUPFR_WKUPF4)) ?
				1UL : 0UL);
	}
	...
	__STATIC_INLINE uint32_t LL_PWR_IsActiveFlag_WU3(void) {
		return ((READ_BIT(PWR->WKUPFR, PWR_WKUPFR_WKUPF3) == (PWR_WKUPFR_WKUPF3)) ?
				1UL : 0UL);
	}
#endif /* defined (PWR_WKUPFR_WKUPF3) */
	...
	__STATIC_INLINE uint32_t LL_PWR_IsActiveFlag_WU2(void) {
		return ((READ_BIT(PWR->WKUPFR, PWR_WKUPFR_WKUPF2) == (PWR_WKUPFR_WKUPF2)) ?
				1UL : 0UL);
	}
	...
	__STATIC_INLINE uint32_t LL_PWR_IsActiveFlag_WU1(void) {
		return ((READ_BIT(PWR->WKUPFR, PWR_WKUPFR_WKUPF1) == (PWR_WKUPFR_WKUPF1)) ?
				1UL : 0UL);
	}
